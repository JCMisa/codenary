...
export default function SignUpPage() {
  return (
    <div className="min-h-screen grid w-full items-center bg-neutral-900 px-4 font-mono text-sm text-white">
      <SignUp.Root>
        <SignUp.Step
          name="start"
          className="mx-auto w-full sm:w-96 space-y-6 bg-neutral-800 px-4 py-8 border-4 border-black shadow-[8px_8px_0_0_#000]"
        >
